function init() {
    ...
    d3.json("fires_2006to2018.json").then((data) => {
  ...
  function buildCharts(sample) {
    ...
    d3.json("fires_2006to2018.json").then((data) => {
      ...
      var barData = [{
        x: sampleValues.slice(0,5).reverse(),
        text: otuLabels.slice(0,10).reverse(),
        type: "bar"
      }];
      // 9. Create the layout for the bar chart. 
      var barLayout = {
        title: "Top 5 Origin of Wildfire",
        yaxis: {
          tickmode: "array",
        ...
        annotations: [{
          ...
          y: -0.25,
          yanchor: 'center',
          text: 'The bar chart displays the top 5 Origin of Wildfire',
          showarrow: false
        }]
      };
      //console.log("hello");
      ...
      var gaugeData = [
        {
          domain: { x: [0, 1], y: [0, 1] },
          value: washFreq,
          title: { text: "<b>Top 5 Origin of Wildfire</b><br>Scrubs per week"},
          type: "indicator",
          mode: "gauge+number",
          gauge: {
            axis: {
